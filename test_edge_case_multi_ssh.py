...
This creates NEW test files without overwriting existing ones."""
import asyncio
...
<body>
    <div id="capture-area">
        <!-- First SSH session to Remote-Device -->
        <span class="prompt">&lt;TUC-EDGE01&gt;</span> <span class="command">stelnet 10.0.0.1</span>
        ...
        <div class="output">sysname Remote-Device</div>
        <div class="output"># ... config ...</div>
        <div class="output">return</div>
        <!-- Second SSH session to Remote-Device2 -->
        <span class="prompt">&lt;TUC-EDGE01&gt;</span> <span class="command">stelnet 10.0.0.2</span>
        ...
        <div class="output">Slot 0: MPU</div>
        <div class="output">Slot 1: LPU</div>
    </div>
</body>
</html>
"""
...
async def generate():
    async with async_playwright() as p:
        ...
        # Use a NEW device name that doesn't conflict
        base = "screenshots/TUC-EDGE01 display current-configuration.png"
