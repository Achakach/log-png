...
def generate_nested_huawei_log(router_name: str = "TUC-TYB91G01HWLEFC303-CPLEF03", filename: str = "") -> int:
    ...
    user_commands = [
        ...
        ("display cpu", ["CPU Usage Stat. Cycle: 60 (Seconds)", "CPU Usage            : 12%", "CPU Usage Stat. Time: 2026-04-07  21:15:30", "CPU Usage Stat. Type: Current"]),
        ("display memory", ["Memory Using Percentage Is: 35%", "System Total Memory Is: 4194304 Kbytes", "System Used Memory Is: 1468006 Kbytes", "System Free Memory Is: 2726298 Kbytes"]),
        ("commandx1", ["Command X1 output", "Line 1", "Line 2"]),
        ("commandx2", ["Command X2 output", "Line 1", "Line 2"]),
        ("commandy1", ["Command Y1 output", "Line 1", "Line 2"]),
        ("commandy2", ["Command Y2 output", "Line 1", "Line 2"]),
